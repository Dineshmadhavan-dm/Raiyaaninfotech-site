...
<div>
   ...
   @if (
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link {{ request()->routeIs('kanbandashboard') ? 'active' : '' }} submenu-toggle d-flex justify-content-between align-items-center"
  ...
  @can('task->project view')

                                <li class="nav-item mt-2">
                                    <a class="nav-link {{ request()->routeIs('projectlist') ? 'active' : '' }} submenu-toggle d-flex justify-content-between align-items-center"
                                        href="{{ route('projectlist') }}" data-tooltip="Project">
                                        <span1>
                                ...
                                @endcan
  @can('task->modulo view')

                            <li class="nav-item mt-2">
                                <a class="nav-link {{ request()->routeIs('modulolist') ? 'active' : '' }} submenu-toggle d-flex justify-content-between align-items-center"
                                    href="{{ route('modulolist') }}" data-tooltip="Module">
                                    <span1>
  ...
  @can('task->task view')
                            <li class="nav-item mt-2">
                                <a class="nav-link {{ request()->routeIs('tasklist') ? 'active' : '' }} submenu-toggle d-flex justify-content-between align-items-center"
                                    href="{{ route('tasklist') }}" data-tooltip="Task">
                                    <span1>
...
<div class="dropdown me-3 me-lg-4">
    <a class="position-relative nav-icon" href="#" role="button" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill  bg-danger-subtle">
