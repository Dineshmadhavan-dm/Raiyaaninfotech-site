...
<x-tabnav>
    ...
    <div class="main-container ">
        ...
        <div class="tab-content">
            <div id="tab1" class="tab-pane {{ request()->routeIs('favicon') ? 'active' : '' }}">
                <div
                    class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
                    <div>
                        <h3 class="fw-bold mb-2">Favicon</h3>
            ...
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-body p-4">
                    <form class="needs-validation" action="{{ route('favlogo_post') }}" novalidate
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold d-block mb-3">
                                <i class="bi bi-image me-2"></i> Favicon
                            </label>
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-4">
                                ...
                                <div class="logo-upload-area rounded-3 border border-2 border-dashed p-4 text-center"
                                    ...
                                    <div id="logoPreview"
                                        ...
                                        @if (isset($settingsfavicon) && $settingsfavicon->favlogo)
                                            <img src="{{ asset('favlogo/' . $settingsfavicon->favlogo) }}"
                                                alt="Current Favicon" class="img-fluid" width="70px">
                                        @endif



                                        <input type="hidden" id="uploaded_logo" name="favlogo">
                                    ...
                                    <input type="file" class="d-none" id="upload_image1" name="favlogo"
                                ...
                                <div class="flex-grow-1">
                                    <div class="alert alert-light bg-light bg-opacity-25 border-0 rounded-3">
                                        <h6 class="fw-semibold mb-2"><i class="bi bi-lightbulb me-2"></i>Favicon
                                            Guidelines
                                        </h6>
                        ...
                        <div class="d-flex justify-content-end pt-2">
                            ...
                            <button type="button" id="submit_form"
                                ...
                                {{ isset($settingsfavicon) && $settingsfavicon->favlogo ? 'Update' : 'Add' }}
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal fade" id="modal_crop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <p class=" text-danger  mt-2 ms-3"> Favicon size : width 500 / height 500 pixels </p>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const originalLogo =
                    "{{ isset($settingsfavicon->favlogo) ? asset('favlogo/' . $settingsfavicon->favlogo) : '' }}";
            ...
            `;
                ...
                document.getElementById('upload_image1').addEventListener('change', function(e) {
                    ...
                    if (file) {
                        // Validate file type
                        const validTypes = ['image/png', 'image/ico'];
                        if (!validTypes.includes(file.type)) {
                            Swal.fire({
                                text: 'Only PNG, Ico images are allowed!',
                                icon: 'error',
                            });
                            this.value = '';
                            return;
                ...
                $('#upload_image1').change(function(event) {
                    ...
                    if (files && files.length > 0) {
                        ...
                        var validTypes = ['image/png', 'image/ico'];
                        if (!validTypes.includes(file.type)) {
                            Swal.fire({
                                text: 'Only PNG, ICO images are allowed!',
                                icon: 'error',
                ...
                $('#crop_and_upload').click(function() {
                    ...
                    var mimeType = currentFileType === 'image/png' ? 'image/png' : 'image/ico';
                ...
                $('#submit_form').click(function(e) {
                    ...
                    const isUpdate = {{ isset($settingsfavicon) ? 'true' : 'false' }};
                    ...
                    $.ajax({
                        url: '{{ route('favlogo_post') }}',
                        method: 'PATCH',
                        data: {
                            favlogo: croppedImage || null,
