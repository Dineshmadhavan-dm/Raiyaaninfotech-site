            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form id="editClientForm" action="{{ route('clients.update', $client->cl_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="d-flex flex-column flex-md-row align-items-center gap-4 mb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h4 class="mb-1">{{ $client->cl_name }}</h4>
                                    <p class="text-muted mb-2">{{ $client->cl_email }}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="cl_email" name="cl_email"
                                    value="{{ $client->cl_email }}" required>
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="cl_password" name="cl_password">
                                <label for="cl_password">New Password</label>
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: xhr.responseJSON?.error || 'Failed to update client',
                                confirmButtonColor: '#3085d6',
                            });
                        }
                    }
