...
<x-layout>
        ...
        <div class="modal fade" id="add{{ $config['id'] }}Modal" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route($config['route']) }}" method="POST" id="{{ strtolower($config['id']) }}Form">
                        @csrf
    ...
    <script>
        async function saveData(id, fieldName) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    // Reload appropriate fieldset content
                    if (id === 'qualification') {
                        reloadFieldset(3);
                    } else {
                        reloadFieldset(5);
        ...
        // Example reloadFieldset function to refresh the fieldset content via AJAX
        function reloadFieldset(step) {
            const url = new URL(window.location.href);
            url.searchParams.set('step', step); // For example: ?step=3 or ?step=5
            ...
            fetch(url.toString(), {
                ...
                .then(res => res.text())
                .then(html => {
                    // Parse the returned HTML and extract only the fieldset part
                    ...
                    if (newFieldset) {
                        ...
                        // Show this fieldset and hide others if needed
    ...
    <div class="container-fluid py-4 px-4">
        ...
        <div class="container-fluid">
            <!-- Multi-step form -->
            <form id="msform" method="POST" class="animate__animated" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="dual-progress-container">
                    ...
                    <ul class="vertical-progress">
                        <li class="{{ $step >= 1 ? ($step > 1 ? 'completed' : 'active') : '' }}">
                            <span class="step-label">
                                <span class="fw-bold text-dark fs-6">Step 1</span> Personal Details
                            </span>
                        </li>
                        <li class="{{ $step >= 2 ? ($step > 2 ? 'completed' : 'active') : '' }}">
                            <span class="step-label">
                                <span class="fw-bold text-dark fs-6">Step 2</span> Family Details
                            </span>
                        </li>
                        <li class="{{ $step >= 3 ? ($step > 3 ? 'completed' : 'active') : '' }}">
                            <span class="step-label">
                                <span class="fw-bold text-dark fs-6">Step 3</span> Education Details
                            </span>
                        </li>
                        <li class="{{ $step >= 4 ? ($step > 4 ? 'completed' : 'active') : '' }}">
                            <span class="step-label">
                                <span class="fw-bold text-dark fs-6 pe-3">Step 4</span> Past Employment
                            </span>
                        </li>
                        <li class="{{ $step >= 5 ? ($step > 5 ? 'completed' : 'active') : '' }}">
                            <span class="step-label">
                                <span class="fw-bold text-dark fs-6">Step 5</span> Current Employment
                            </span>
                        </li>
                        <li class="{{ $step >= 6 ? ($step > 6 ? 'completed' : 'active') : '' }}">
                            <span class="step-label">
                                <span class="fw-bold text-dark fs-6">Step 6</span> Professional References
                            </span>
                        </li>
                    </ul>
                    ...
                    <ul id="progressbar">
                        <li class="{{ $step >= 1 ? ($step > 1 ? 'completed' : 'active') : '' }}">
                            <span class="progress-label">
                                <p class="fw-bold text-dark">Step 1</p>
                                Personal Details
                            </span>
                        </li>
                        <li class="{{ $step >= 2 ? ($step > 2 ? 'completed' : 'active') : '' }}">
                            <span class="progress-label">
                                <p class="fw-bold text-dark">Step 2</p>
                                Family Details
                            </span>
                        </li>
                        <li class="{{ $step >= 3 ? ($step > 3 ? 'completed' : 'active') : '' }}">
                            <span class="progress-label">
                                <p class="fw-bold text-dark">Step 3</p>
                                Education Details
                            </span>
                        </li>
                        <li class="{{ $step >= 4 ? ($step > 4 ? 'completed' : 'active') : '' }}">
                            <span class="progress-label">
                                <p class="fw-bold text-dark">Step 4</p>
                                Past Employment
                            </span>
                        </li>
                        <li class="{{ $step >= 5 ? ($step > 5 ? 'completed' : 'active') : '' }}">
                            <span class="progress-label">
                                <p class="fw-bold text-dark">Step 5</p>
                                Current Employment
                            </span>
                        </li>
                        <li class="{{ $step >= 6 ? ($step > 6 ? 'completed' : 'active') : '' }}">
                            <span class="progress-label">
                                <p class="fw-bold text-dark">Step 6</p>
                ...
                <div class="form-container">
                    ...
                    <fieldset style="{{ $step != 1 ? 'display:none;' : '' }}">
                        <div class="card">
                            ...
                            <div class="card-body mt-3">
                                ...
                                <div class="row">
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fullname" name="fullname"
                                                value="{{ old('fullname', $personal->fullname ?? '') }}" required>

                                            <p class="error-message text-danger" style="display: none;">
                                            </p>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            <label for="personal_email" class="form-label">Email
                                                (Personal)
                                                <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control email-input" id="personal_email"
                                                name="personal_email"
                                                value="{{ old('personal_email', $personal->personal_email ?? '') }}"
                                                required>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            <label for="personal_mobile" class="form-label">Personal
                                                Mobile No
                                                <span class="text-danger">*</span></label>
                                            <input type="tel" class="form-control" id="personal_mobile"
                                                name="personal_mobile" maxlength="13"
                                                value="{{ old('personal_mobile', $personal->personal_mobile ?? '') }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gender" id="male"
                                                        value="male" required {{ old('gender', $personal->gender ?? '') === 0 ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input" type="radio" name="gender"
                                                        id="female" value="female" required {{ old('gender', $personal->gender ?? '') === 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fathername" name="fathername"
                                                value="{{ old('fathername', $personal->fathername ?? '') }}">
                                        </div>
                                    </div>

                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            <label for="employee_image" class="form-label">Employee
                                                Image</label>
                                            <div class="image-upload-container">
                                                <input type="file" class="form-control mt-1" id="employee_image"
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="marital_status"
                                                        id="married" value="married" {{ old('marital_status', $personal->marital_status ?? '') == 1 ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="married">Married</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="marital_status"
                                                        id="single" value="single" {{ old('marital_status', $personal->marital_status ?? '') == 0 ? 'checked' : '' }}>
    ...
    <div class="form-group">
        ...
        <ul id="bloodgroup-list" class="list-group" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pancard_no" name="pancard_no"
                                                value="{{ old('pancard_no', $personal->pancard_no ?? '') }}"
                                                maxlength="10">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="aadhaar_no" name="aadhaar_no"
                                                value="{{ old('aadhaar_no', $personal->aadhaar_no ?? '') }}"
                                                maxlength="14">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            <label for="pincode" class="form-label">Pincode(India Only)</label>
                                            <input type="number" class="form-control" id="pincode" name="pincode"
                                                value="{{ old('pincode', $personal->pincode ?? '') }}" min="100000"
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="flatno" name="flatno"
                                                value="{{ old('flatno', $personal->flatno ?? '') }}">
                                        </div>
                                    </div>
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="street" name="street"
                                                value="{{ old('street', $personal->street ?? '') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="address" name="address"
                                                rows="3">{{ old('address', $personal->address ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="country" name="country"
                                                value="{{ old('country', $personal->country ?? '') }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="state" name="state"
                                                value="{{ old('state', $personal->state ?? '') }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city"
                                                value="{{ old('city', $personal->city ?? '') }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            <label for="c_person_emergency" class="form-label">Contact
                                                Person
                                                Name</label>
                                            <input type="text" class="form-control" id="c_person_emergency"
                                                name="c_person_emergency"
                                                value="{{ old('c_person_emergency', $personal->c_person_emergency ?? '') }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="relationship"
                                                    name="relationship_name"
                                                    value="{{ old('relationship_name', $personal->relationship ?? '') }}"
                                                    placeholder="Search relation ...">
                                                <input type="hidden" id="relationship_id" name="relationship"
                                                    value="{{ old('relationship', $personal->relationship ?? '') }}">
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" id="emergency_contact"
                                                name="emergency_contact" maxlength="13"
                                                value="{{ old('emergency_contact', $personal->emergency_contact ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div id="familyContainer">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            <button type="button" id="addFamily" class="btn btn-outline-primary mb-3">
                                        ...
                                        @foreach ($families as $index => $family)
                                            <div class="family-entry ">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="fa_name_{{ $index }}" class="form-label">Name
                                                            </label>
                                                            <input type="text" class="form-control" id="fa_name_{{ $index }}"
                                                                name="fa_name[]" value="{{ $family->fa_name }}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    id="fa_relation_{{ $index }}" name="fa_relation_name[]"
                                                                    value="{{ $family->fa_relation_name ?? '' }}"
                                                                    placeholder="Search relation ..."
                                                                    oninput="searchFamilyRelationship(this)">


                                                                <input type="hidden" id="fa_relation_id_{{ $index }}"
                                                                    name="fa_relation[]"
                                                                    value="{{ $family->fa_relation ?? '' }}">


                                                            </div>
                                                            <ul id="fa_relation_list_{{ $index }}" class="list-group"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="fa_occupation_{{ $index }}" name="fa_occupation[]"
                                                ...
                                                @if ($index > 0)
                                                    <div class="text-end">
                                                        <button type="button" class="btn btn-outline-danger btn-sm remove-family">
                                    ...
                                    @else
                                        <div class="family-entry">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label for="fa_relation_0" class="form-label">Relation</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="fa_relation_0"
                                                                name="fa_relation_name[]" placeholder="Search relation ..."
                                                                oninput="searchFamilyRelationship(this)">
                                                            <input type="hidden" id="fa_relation_id_0" name="fa_relation[]">
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label for="fa_occupation_0" class="form-label">Occupation</label>
                                                        <input type="text" class="form-control" id="fa_occupation_0"
                                                            name="fa_occupation[]">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="educationContainer">
                                    <div class="text-end">
                                        <button type="button" id="addEducation" class="btn btn-outline-primary mb-3">
                                            <i class="bi bi-plus-circle me-2"></i>Add
                                        </button>
                                    </div>
                                        ...
                                        @foreach ($educations as $index => $education)
                                            <div class="education-entry ">
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    id="qualification_{{ $index }}" name="qualification_name[]"
                                                                    value="{{ old('qualification', $education->qualification_name ?? '') }}"
                                                                    placeholder="Search qualification ..."
                                                                    oninput="searchQualification(this)" required>


                                                                <input type="hidden" id="qualification_id_{{ $index }}"
                                                                    name="qualification[]"
                                                            ...
                                                            <ul id="qualification_list_{{ $index }}" class="list-group"
                                                                style=" position: absolute;
                                                    ...
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            <label for="edu_location_{{ $index }}" class="form-label">Location
                                                                <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control"
                                                                id="edu_location_{{ $index }}" name="edu_location[]"
                                                ...
                                                <div class="row ">
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            <label for="edu_from_date_{{ $index }}" class="form-label">From<span
                                                                    class="text-danger">*</span></label>
                                                            <input type="date" class="form-control"
                                                                id="edu_from_date_{{ $index }}" name="edu_from_date[]"
                                                                value="{{ $education->edu_from_date }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            <label for="edu_to_date_{{ $index }}" class="form-label">To</label>
                                                            <input type="date" class="form-control"
                                                                id="edu_to_date_{{ $index }}" name="edu_to_date[]"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="specialization_{{ $index }}"
                                                                class="form-label">Specialization <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control"
                                                                id="specialization_{{ $index }}" name="specialization[]"
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            <label for="percentage_grade_{{ $index }}" class="form-label">
                                                                Percentage <span class="text-danger">*</span>
                                                            </label>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control percentage-input"
                                                                    id="percentage_grade_{{ $index }}" name="percentage_grade[]"
                                    ...
                                    @else
                                        <div class="education-entry">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="qualification_0" class="form-label">Qualification
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="qualification_0"
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name_of_institution_0"
                                                            name="name_of_institution[]"
                                                            placeholder="School/College/University" required>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="edu_location_0" class="form-label">Location
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="edu_location_0"
                                                            name="edu_location[]" placeholder="Enter location" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="edu_from_date_0" class="form-label">From<span
                                                                class="text-danger">*</span></label>
                                                        <input type="date" class="form-control" id="edu_from_date_0"
                                                            name="edu_from_date[]" required>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="edu_to_date_0" class="form-label">To<span
                                                    class="text-danger ">*</span></label>
                                                        <input type="date" class="form-control" id="edu_to_date_0"
                                                            name="edu_to_date[]" required>
                                                    </div>
                                                </div>

                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="specialization_0" class="form-label">Specialization
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="specialization_0"
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="percentage_grade_0" class="form-label">
                                                            Percentage <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control percentage-input"
                                    ...
                                    <div class="past-employment-entry mb-4 border-bottom pb-4">
                                        <div class="form-group mb-3">
                                            <label for="employed_as" class="form-label">Employed As <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select" id="employed_as" name="employed_as[]" required>
                                        ...
                                        <div id="experienceFields" class="experience-fields" style="display: none;">
                                            <div class="row">
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        <label for="past_organisation_name"
                                                            class=" form-label">Organisation Name <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                            id="past_organisation_name" name="past_organisation_name[]"
                                                            placeholder="Enter Organisation Name">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        <label for="past_department" class="form-label">Department
                                                        </label>
                                                        <input type="text" class="form-control" id="past_department"
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        <label for="past_designation" class="form-label">Designation
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="past_designation"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        <label for="past_role" class="form-label">Role <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="past_role"
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" id="past_location"
                                                            name="past_location[]" placeholder="Enter Location">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        <label for="past_annual_ctc" class="form-label">Annual CTC
                                                            (₹)
                                                        </label>
                                                        <input type="text" class="form-control past-annual-ctc"
                                                            name="past_annual_ctc[]" placeholder="Enter Annual CTC">
                                            ...
                                            <div class="row ">
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="past_from_date" class="form-label">Period of
                                                            Service From <span class="text-danger">*</span></label>
                                                        <input type="date" class="form-control" id="past_from_date"
                                                            name="past_from_date[]">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="past_to_date" class="form-label">To <span
                                                                class="text-danger">*</span></label>
                                                        <input type="date" class="form-control" id="past_to_date"
                                                            name="past_to_date[]">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group ">
                                                        <label for="has_uan" class="form-label">Do you have
                                                            UAN (PF) number </label>
                                                        <select class="form-select" id="has_uan" name="has_uan[]">
                                            ...
                                            <div class="form-group  uan-number-field" style="display: none;">
                                                ...
                                                <input type="text" class="form-control uan-input" id="uan_number"
                            ...
                            <div class="card-body ">
                                <div class="row ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="cur_department"
                                                        name="dep_name"
                                                        value="{{ old('dep_name', $$personal->cur_department ?? '') }}"
                                                    ...
                                                    <input type="hidden" id="dep_id" name="cur_department"
                                                        value="{{ old('cur_department', $personal->cur_department ?? '') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="cur_designation"
                                                        name="des_name"
                                                        value="{{ old('des_name', $$personal->cur_designation ?? '') }}"
                                                        placeholder="Search designation ...">
                                                    <input type="hidden" id="des_id" name="cur_designation"
                                                        value="{{ old('cur_designation', $personal->cur_designation ?? '') }}">
                                                    <button type="button" class="btn btn-outline-primary"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="cur_location"
                                                        name="branch_name"
                                                        value="{{ old('branch_name', $$personal->cur_location ?? '') }}"
                                                        placeholder="Search location ..." required>
                                                    <input type="hidden" id="branch_id" name="cur_location"
                                                        value="{{ old('cur_location', $personal->cur_location ?? '') }}">
                                                    <button type="button" class="btn btn-outline-primary"
                                                        data-bs-toggle="modal"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-xxl-4">
                                            <div class="form-group">
                                                <label for="cur_annual_ctc" class="form-label">Annual CTC (₹)
                                                    <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="cur_annual_ctc"
                                                    name="cur_annual_ctc"
                                                    value="{{ old('cur_annual_ctc', $$personal->cur_annual_ctc ?? '') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="jobtype"
                                                        name="jobtype_name"
                                                        value="{{ old('jobtype_name', $personal->jobtype ?? '') }}"
                                                        placeholder="Search jobtype ...">
                                                    <input type="hidden" id="jobtype_id" name="jobtype"
                                                        value="{{ old('jobtype', $personal->jobtype ?? '') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4">
                                                <div class="form-group">
                                                    ...
                                                    class="text-danger ">*</span></label>
                                                    <input type="date" class="form-control" id="dojprovision_from_date"
                                            ...
                                            <div class="col-xxl-4">
                                                <div class="form-group">
                                                    ...
                                                    class="text-danger ">*</span></label>
                                                    <input type="date" class="form-control" id="provision_to_date"
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <button type="button" name="previous"
                                    class="btn btn-secondary previous btn-sm action-button"><i
                                        class="bi bi-arrow-left me-2"></i>Previous</button>
                                <button type="button" name="next" class="btn btn-primary next btn-sm action-button"
                                    data-step="5">Next <i class="bi bi-arrow-right ms-2"></i></button>
                            </div>
                    </fieldset>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="referencesContainer">
                                    <div class="text-end">
                                        <button type="button" id="addReference" class="btn btn-outline-primary mb-3">
                                            <i class="bi bi-plus-circle me-2"></i>Add
                                        </button>
                                    </div>
                                        ...
                                        @foreach ($references as $index => $reference)
                                            <div class="reference-entry ">
                                                <div class="row ">
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            <label for="ref_name_{{ $index }}" class="form-label">Reference
                                                                Name <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="ref_name_{{ $index }}"
                                                                name="ref_name[]" value="{{ $reference->ref_name }}"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="ref_designation_{{ $index }}"
                                                                class="form-label">Designation <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control"
                                                                id="ref_designation_{{ $index }}" name="ref_designation[]"
                                                ...
                                                <div class="row ">
                                                    <div class="col-xxl-4">
                                                        <div class="form-group">
                                                            <label for="mobile_no_{{ $index }}" class="form-label">Mobile
                                                                No</label>
                                                            <input type="tel" class="form-control" id="mobile_no_{{ $index }}"
                                                                name="mobile_no[]" value="{{ $reference->mobile_no }}"
                                    ...
                                    @else
                                        <div class="reference-entry ">
                                            <div class="row ">
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="ref_name"
                                                            name="ref_name[]" placeholder="Enter name" required>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="ref_organization_name" class="form-label">Organization
                                                            Name <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="ref_organization_name"
                                                            name="ref_organization_name[]"
                                                            placeholder="Enter organization name" required>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        <label for="ref_designation" class="form-label">Designation
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="ref_designation"
                                                            name="ref_designation[]" placeholder="Enter designation"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="col-xxl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" class="form-control" id="mobile_no" maxlength="13"
...
<div class="col-xxl-4">
    <div class="form-group">
        ...
        <small class="text-danger error-message"
            style="display:none;">Invalid email format</small>
    </div>
</div>
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <button type="button" name="previous"
                                class="btn btn-sm btn-secondary previous action-button"><i
                                    class="bi bi-arrow-left me-2"></i>Previous</button>
                            <button type="submit" class="btn btn-sm btn-primary action-button">Submit <i
...
<script>
    ...
    // Update the percentage input handling in your JavaScript
    ...
    function handlePercentageBlur() {
        ...
        // Validate the final value (0 to 100, up to 2 decimal places)
        const pattern = /^(100(\.00?)?|\d{1,2}(\.\d{1,2})?)$/;
    ...
    // Initialize on page load and when adding new education entries
    document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.past-annual-ctc').forEach(function (input) {
            input.addEventListener('input', function () {
                ...
                this.setSelectionRange(pos + (newLength - originalLength), pos + (
                    newLength -
                    originalLength));
            });
   ...
   function initializePhoneInput(input) {
    ...
    const iti = window.intlTelInput(input, {
        ...
        autoPlaceholder: "off",
        nationalMode: true, // Important: This helps handle the number without country code
    ...
    // If empty, set to country code
    if (!currentValue.trim()) {
        currentCountryCode = `+${iti.getSelectedCountryData().dialCode}`;
        input.value = currentCountryCode;
        input.setSelectionRange(currentCountryCode.length, currentCountryCode.length);
    }
    ...
    input.addEventListener('countrychange', function () {
        ...
        // Extract just the local number
        let localNumber = currentVal;
        if (currentVal.startsWith(countryCodeDigits)) {
            localNumber = currentVal.substring(countryCodeDigits.length);
        }

        input.value = currentCountryCode + localNumber;
        input.setSelectionRange(currentCountryCode.length, currentCountryCode.length);
    });
    ...
    input.addEventListener('input', function (e) {
        ...
        if (inputVal.startsWith(countryCodeDigits)) {
            inputVal = inputVal.substring(countryCodeDigits.length);
        }

        // Allow only 10 digits
        inputVal = inputVal.substring(0, 10);

        input.value = countryCode + inputVal;
    ...
    input.addEventListener('blur', function () {
        ...
        //     this.classList.add('is-invalid');
        //     Toastify({
        //         text: `Phone number must have exactly 10 digits (found ${localNumber.length} digits)`,
        //         duration: 3000,
        //         gravity: "top",
        //         position: "right",
        //         backgroundColor: "#EF4444",
    ...
    input.addEventListener('keydown', function (e) {
        ...
        // Allow only digits
        if (e.key.length === 1 && !/\d/.test(e.key) && !['+', '-', '(', ')', ' '].includes(e.key)) {
            e.preventDefault();
        }
    });
...
function validatePhoneNumber(input) {
    ...
    //     return {
    //         isValid: false,
    //         message: `Phone number must have exactly 10 digits (found ${localNumber.length} digits)`
    //     };
    // }
...
function validateRequiredFields(fieldset) {
    ...
    // Special handling for Professional References fieldset
    ...
    requiredFields.forEach(field => {
        ...
        if (isProfessionalReferences && (field.name.includes('email_ref') || field.type === 'email')) {
            return; // Skip validation for email in professional references
        }

        let fieldName = field.getAttribute('name') || field.getAttribute('id');
        let fieldLabel = field.labels?.[0]?.textContent?.trim() || fieldName;
        ...
        if (field.type === 'radio') {
            ...
            if (!isChecked) {
                radioGroup.forEach(radio => {
                    radio.closest('.form-check')?.classList.add('border-danger');
                    setTimeout(() => radio.closest('.form-check')?.classList.remove('border-danger'), 3000);
                });
    ...
    if (iti) {
        ...
        if (!field.value.trim() || field.value.replace(/\D/g, '').length !== 10) {
            field.classList.add('is-invalid');
            field.style.borderColor = '#dc3545';
            field.style.boxShadow = '0 0 0 0.25rem rgba(220, 53, 69, 0.25)';
            setTimeout(() => {
            ...
            // Skip email validation for Professional References
            if (!isProfessionalReferences) {
                if (!field.value.trim()) {
                    field.classList.add('is-invalid');
                    field.style.borderColor = '#dc3545';
                    field.style.boxShadow = '0 0 0 0.25rem rgba(220, 53, 69, 0.25)';
                    ...
                    missingFields.push(fieldLabel || field.name + " - Invalid email format");
                    isValid = false;
                }
            }
    ...
    if (!isValid && missingFields.length > 0) {
        ...
        if (missingFields.length === 1) {
            errorMessage = `Please fill the mandatory field: ${missingFields[0]}`;
        } else {
            errorMessage = `Please fill the mandatory fields: ${missingFields.join(', ')}`;
        }
...
function isValidEmail(email) {
    ...
    current_fs[0].checkValidity = function() { return true; };

    // Validate all required fields including phone validation
    ...
    submitStep(step, current_fs, function (success) {
        ...
        if (success) {
            ...
            $(".vertical-progress li").eq($("fieldset").index(
                current_fs))
                .addClass("completed");
    ...
    resultField.value = result.trim() || '0 Days';
            ...
            // Handle UAN number field visibility
            ...
            document.getElementById('addPastEmployment')?.addEventListener('click', function () {
                ...
                newEntry.innerHTML = `
                  <input type="hidden" name="employed_as[]" value="1">
                             ...
                             <div class="col-xxl-4">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="past_organisation_name_${pastEmploymentCount}"
                                           name="past_organisation_name[]" placeholder="Enter Organisation Name" required>
                                </div>
                            </div>
                               ...
                               <div class="col-xxl-4">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="past_department_${pastEmploymentCount}"
                                           name="past_department[]" placeholder="Enter Department" required>
                                </div>
                            </div>
                          <div class="col-xxl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="past_designation_${pastEmploymentCount}"
                                           name="past_designation[]" placeholder="Enter Designation" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                             ...
                             <div class="col-xxl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="past_role_${pastEmploymentCount}"
                                           name="past_role[]" placeholder="Enter Role" required>
                                </div>
                            </div>
                             ...
                             <div class="col-xxl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="past_location_${pastEmploymentCount}"
                                           name="past_location[]" placeholder="Enter Location" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control past-annual-ctc"
                                           name="past_annual_ctc[]"  id="past_annual_ctc_${pastEmploymentCount}"  placeholder="Enter Annual CTC" required>
                                </div>
                            </div>
                        </div>
...
<div class="col-xxl-4">
 ...
 <div class="form-group">
                ...
                <select class="form-select" id="has_uan_${pastEmploymentCount}" name="has_uan[]" required>
                    <option value="">Select Option</option>
                    <option value="1">Yes</option>
                    <option value="0">No</option>
                </select>
    ...
    <div class="text-end">
        <button type="button" class="btn btn-outline-danger btn-sm remove-reference">
            ...
            $('#addFamily').click(function () {
                if (familyCount < 5) {
                    familyCount++;
                    const newEntry = `<div class="family-entry ">


                            <div class="row ">
                        <div class="col-lg-4">

                            <div class="form-group"><label for="fa_name_${familyCount}" class="form-label">Name</label>
         ...
         <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control qualification-input"
                                   ...
                                   name="qualification_name[]"
                                   placeholder="Search qualification ..."    oninput="searchQualification(this)">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            $('input[type="date"]').on('keydown', function (e) {
                ...
                if ((e.keyCode === 65 || e.keyCode === 67 || e.keyCode === 88) && e.ctrlKey ===
                    true) {
                    return;
                }

                // Allow: numbers (0-9) and dash (-)
                if ((e.keyCode >= 48 && e.keyCode <= 57) || e.keyCode === 189 || e.keyCode ===
                    109) {
                    ...
                    if ((currentPos === 4 || currentPos === 7) && e.keyCode !== 189 && e
                        .keyCode !== 109) {
                        this.value = currentValue.substring(0, currentPos) + '-' + currentValue
            ...
            form.addEventListener('submit', function (e) {
                if (!$('#cropped_image_data').val()) {
                    e.preventDefault();
                    showError('Please select and crop an image.');
                    $('html, body').animate({
                        scrollTop: $('#employee_image').offset().top -
                            100
                    }, 500);
                    $('#employee_image').addClass(
                        'animate__animated animate__headShake');
                    setTimeout(() => {
                        $('#employee_image').removeClass(
                            'animate__animated animate__headShake');
                    }, 1000);
                }
            });
...
.form-check.border-danger .form-check-input {
    border-color: #dc3545;
}
</style>

<script>
    function fetchAndDisplay(url, inputSelector, listSelector, itemClass, idKey, nameKey) {
        let query = $(inputSelector).val().trim();
            ...
            success: function (response) {
                ...
                if (response.length > 0) {
                    response.forEach(function (item) {
                        $list.append(
                            `<li class="list-group-item ${itemClass}" data-id="${item[idKey]}">${item[nameKey]}</li>`
                        );
                    });
                } else {
    ...
    function bindSearch(inputSelector, listSelector, url, itemClass, idKey, nameKey) {
        // Only bind events if they haven't been bound already
        if (!$(inputSelector).data('bound')) {
            $(inputSelector).on('input focus', function () {
                fetchAndDisplay(url, inputSelector, listSelector, itemClass, idKey, nameKey);
            }).data('bound', true);
    ...
    $(document).ready(function () {
        bindSearch(
            ...
            "{{ route('qualification.search') }}", "qualification-item", "qua_id", "qua_name"
        );
        bindSearch(
            "#cur_department", "#curdepartment-list",
            "{{ route('department.search') }}", "curdepartment-item", "dep_id", "dep_name"
        );
        bindSearch(
            "#bloodgroup", "#bloodgroup-list",
            "{{ route('bloodgroup.search') }}", "bloodgroup-item", "bloodgroup_id", "bloodgroup_name"
        );
        bindSearch(
            "#relationship", "#relationship-list",
            "{{ route('relationship.search') }}", "relationship-item", "relationship_id",
            "relationship_name"
        );
        bindSearch(
            "#fa_relation", "#relationship-list",
            "{{ route('relationship.search') }}", "relationship-item", "relationship_id",
            "relationship_name"
        );
        bindSearch(
            "#jobtype", "#jobtype-list",
            "{{ route('jobtype.search') }}", "jobtype-item", "jobtype_id", "jobtype_name"
        );

        bindSearch(
            "#cur_designation", "#curdesignation-list",
            "{{ route('designation.search') }}", "curdesignation-item", "des_id", "des_name"
        );



        bindSearch(
            "#cur_location", "#curlocation-list",
            "{{ route('location.search') }}", "curlocation-item", "branch_id", "branch_name"
        );

        bindSearch(
            "#email_company", "#companyemail-list",
            "{{ route('companyemail.search') }}", "companyemail-item", "companyemail_id",
            "companyemail_name"
        );
    });
  ...
  // Update the bindBloodgroupSearch function to prevent manual input
function bindBloodgroupSearch() {
    const inputSelector = "#bloodgroup";
    const listSelector = "#bloodgroup-list";
    const url = "{{ route('bloodgroup.search') }}";
    const itemClass = "bloodgroup-item";
    const idKey = "bloodgroup_id";
    const nameKey = "bloodgroup_name";

    // Prevent typing and only allow selection
    ...
    $(inputSelector).on('click focus', function() {
    ...
    function bindJobtypeSearch() {
        const inputSelector = "#jobtype";
        const listSelector = "#jobtype-list";
        const url = "{{ route('jobtype.search') }}";
        const itemClass = "jobtype-item";
        const idKey = "jobtype_id";
        const nameKey = "jobtype_name";
    ...
    function bindBranchSearch() {
        const inputSelector = "#cur_location";
        const listSelector = "#curlocation-list";
        const url = "{{ route('location.search') }}";
        const itemClass = "curlocation-item";
        const idKey = "branch_id";
        const nameKey = "branch_name";
    ...
    function bindDesignationSearch() {
        const inputSelector = "#cur_designation";
        const listSelector = "#curdesignation-list";
        const url = "{{ route('designation.search') }}";
        const itemClass = "curdesignation-item";
        const idKey = "des_id";
        const nameKey = "des_name";
    ...
    function bindDepartmentSearch() {
        const inputSelector = "#cur_department";
        const listSelector = "#curdepartment-list";
        const url = "{{ route('department.search') }}";
        const itemClass = "curdepartment-item";
        const idKey = "dep_id";
        const nameKey = "dep_name";
    ...
    function bindRelationshipSearch() {
        const inputSelector = "#relationship";
        const listSelector = "#relationship-list";
        const url = "{{ route('relationship.search') }}";
        const itemClass = "relationship-item";
        const idKey = "relationship_id";
        const nameKey = "relationship_name";
    ...
    $(document).ready(function () {
        bindBloodgroupSearch();
        bindRelationshipSearch();
        bindJobtypeSearch();
        bindDepartmentSearch();
        bindDesignationSearch();
        bindBranchSearch();


    });
    // Function to search relationships for family members
    function searchFamilyRelationship(inputElement) {
        const search = $(inputElement).val();
        const inputId = inputElement.id; // e.g. fa_relation_2
        const listId = `${inputId}_list`; // fa_relation_2_list
    ...
    // Handle click on relationship items for family members



    $(document).on('click', '.relation-item', function () {
        const inputId = $(this).data('input');
        const name = $(this).data('name');
        const id = $(this).data('id');

        $(`#${inputId}`).val(name);
        $(`#${inputId.replace('fa_relation_', 'fa_relation_id_')}`).val(id); // hidden input set
        $(`#${inputId}_list`).hide();
    });



    // Close relationship lists when clicking outside
    $(document).on("click", function (e) {
        if (!$(e.target).closest("input[id^='fa_relation_']").length &&
            !$(e.target).closest("ul[id^='fa_relation_list_']").length) {
            $("ul[id^='fa_relation_list_']").hide();
        }
    });
    ...
    function searchQualification(inputElement) {
        const search = $(inputElement).val();
        const inputId = inputElement.id; // e.g. qualification_2
        const listId = `${inputId}_list`; // qualification_2_list
    ...
    $(document).on('click', '.qualification-item', function () {
        const inputId = $(this).data('input');
        const name = $(this).data('name');
        const id = $(this).data('id');

        $(`#${inputId}`).val(name);
        $(`#${inputId.replace('qualification_', 'qualification_id_')}`).val(id); // hidden input set
        $(`#${inputId}_list`).hide();
    });
    ...
    // Close relationship lists when clicking outside
    $(document).on("click", function (e) {
        if (!$(e.target).closest("input[id^='qualification_']").length &&
            !$(e.target).closest("ul[id^='qualification_list_']").length) {
            $("ul[id^='qualification_list_']").hide();
        }
    });
</script>
