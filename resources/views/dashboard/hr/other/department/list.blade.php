...
<x-tabnav>
    ...
    <div class="main-container ">
        ...
        <div class="tab-content">
            <div id="tab2" class="tab-pane {{ request()->routeIs('department') ? 'active' : '' }}">
                        ...
                        <div class="col-lg-8">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    <form
                                        action="{{ isset($editDepartment) ? route('departmentupdate', $editDepartment->dep_id) : route('departmentpost') }}"
                                        method="post">
                                        @csrf
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="dep_name" name="dep_name"
                                                value="{{ isset($editDepartment) ? $editDepartment->dep_name : old('dep_name') }}">
                                            @error('dep_name')
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary px-4" id="submit_form">
                                                {{ isset($editDepartment) ? 'Update' : 'Add' }}
                                            </button>
                                    ...
                                    <tbody>
                                        @foreach ($dep as $it)
                                            <tr class="text-center align-middle">
                                                ...
                                                <td class="align-middle">{{ $it->dep_name }}</td>
                                                <td class="align-middle">
                                                    <div class="d-flex justify-content-center gap-2">

                                                        <a href="{{ route('departmentedit', $it->dep_id) }}"
                                                        ...
                                                        <form action="{{ route('departmentdelete', $it->dep_id) }}"
