...
<x-tabnav>
    ...
    <div class="main-container ">
        ...
        <div class="tab-content">
            <div id="tab7" class="tab-pane {{ request()->routeIs('relationship') ? 'active' : '' }}">
                        ...
                        <div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 mt-2">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">relationship
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    <form
                                        action="{{ isset($editRelationship) ? route('relationshipupdate', $editRelationship->relationship_id) : route('relationshippost') }}"
                                        method="post">
                                        @csrf
                                        @if (isset($editRelationship))
                                            @method('PUT')
                                        @endif

                                        <div class="form-group mb-3">
                                            <label for="relationship_name" class="form-label">relationship Name</label>
                                            <input type="text" class="form-control" id="relationship_name"
                                                name="relationship_name"
                                                value="{{ isset($editRelationship) ? $editRelationship->relationship_name : old('relationship_name') }}">
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary px-4" id="submit_form">
                                                {{ isset($editRelationship) ? 'Update' : 'Add' }}
                                            </button>
                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($relationship as $it)
                                            <tr class="text-center align-middle">
                                                <td class="align-middle">{{ $loop->iteration }}</td>
                                                <td class="align-middle">{{ $it->relationship_name }}</td>
                                                <td class="align-middle">
                                                    <div class="d-flex justify-content-center gap-2">

                                                        <a href="{{ route('departmentedit', $it->relationship_id) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('relationshipdelete', $it->relationship_id) }}"
