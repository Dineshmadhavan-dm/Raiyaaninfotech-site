...
<x-tabnav>
    ...
    <div class="main-container ">
        ...
        <div class="vertical-tabs ">
            ...
            <a href="{{ route('holidaytype') }}" onclick="switchTab('tab8', event)">
                <div class="tab-header {{ request()->routeIs('holidaytype') ? 'active' : '' }}">
                    <h3><i class="bi bi-briefcase me-2"></i>Holiday Type</h3>
                </div>
            </a>
        ...
        <div class="tab-content">
            <div id="tab8" class="tab-pane {{ request()->routeIs('holidaytype') ? 'active' : '' }}">
                        ...
                        <div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 mt-2">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Holidaytype</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    <form
                                        action="{{ isset($editholidaytype) ? route('holidaytypeupdate', $editholidaytype->holidaytype_id) : route('holidaytypepost') }}"
                                        method="post">
                                        @csrf
                                        @if (isset($editholidaytype))
                                            @method('PUT')
                                        @endif

                                        <div class="form-group mb-3">
                                            <label for="holidaytype_name" class="form-label">holidaytype Name</label>
                                            <input type="text" class="form-control" id="holidaytype_name"
                                                name="holidaytype_name"
                                                value="{{ isset($editholidaytype) ? $editholidaytype->holidaytype_name : old('holidaytype_name') }}">
                                            @error('holidaytype_name')
                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($holidaytype as $it)
                                            <tr class="text-center align-middle">
                                                <td class="align-middle">{{ $loop->iteration }}</td>
                                                <td class="align-middle">{{ $it->holidaytype_name }}</td>
                                                <td class="align-middle">
                                                    <div class="d-flex justify-content-center gap-2">

                                                        <a href="{{ route('holidaytypeedit', $it->holidaytype_id) }}"
                                                            class="btn btn-sm btn-icon btn-soft-warning  hover-grow "
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Edit holidaytype">
                                                            <i class="bi bi-pencil "></i>
                                                        </a>

                                                        <form
                                                            action="{{ route('holidaytypedelete', $it->holidaytype_id) }}"
                        ...
                        deleteForms.forEach(form => {
                            form.addEventListener('submit', function(e) {
                                ...
                                Swal.fire({
                                    ...
                                    text: "Are you sure you want to delete this holidaytype?'",
                                    icon: 'warning',
