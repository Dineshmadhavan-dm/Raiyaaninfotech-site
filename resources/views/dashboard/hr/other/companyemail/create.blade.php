<x-layout>
    @section('title', 'Create Company Email')
                                        ...
                                        @if ($employee->status_for_stepform >= 1 && $employee->status_for_stepform <= 5)
                                            <span>
                                                <a href="{{ route('empedit', $employee->emp_id) }}"
                                                    ...
                                                    <p class="mt-1">
                                                        <i class="bi bi-hand-index-thumb me-2 bouncing-hand"></i>
                                                        Navigation Employee
                                                        Form
                                                    </p>
                                                </a>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form id="emailForm" method="post" action="{{ route('companyemail.store') }}">
                            @csrf
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary px-4" id="submitBtn"
                                    {{ $employee->status_for_stepform == 6 ? '' : 'disabled' }}>Add</button>
                            </div>
                        </form>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#emailForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Toastify({
                            text: "Email credentials created successfully",
                            duration: 2000,
                            close: false,
                            gravity: "top",
                            position: "right",
