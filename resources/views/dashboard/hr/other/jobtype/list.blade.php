...
<x-tabnav>
    ...
    <div class="main-container ">
        ...
        <div class="tab-content">
            <div id="tab6" class="tab-pane {{ request()->routeIs('jobtype') ? 'active' : '' }}">
                        ...
                        <div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 mt-2">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">jobtype</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    <form
                                        action="{{ isset($editjobtype) ? route('jobtypeupdate', $editjobtype->jobtype_id) : route('jobtypepost') }}"
                                        method="post">
                                        @csrf
                                        @if (isset($editjobtype))
                                            @method('PUT')
                                        @endif

                                        <div class="form-group mb-3">
                                            <label for="jobtype_name" class="form-label">jobtype Name</label>
                                            <input type="text" class="form-control" id="jobtype_name"
                                                name="jobtype_name"
                                                value="{{ isset($editjobtype) ? $editjobtype->jobtype_name : old('jobtype_name') }}">
                                            @error('jobtype_name')
                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($jobtype as $it)
                                            <tr class="text-center align-middle">
                                                <td class="align-middle">{{ $loop->iteration }}</td>
                                                <td class="align-middle">{{ $it->jobtype_name }}</td>
                                                <td class="align-middle">
                                                    <div class="d-flex justify-content-center gap-2">

                                                        <a href="{{ route('jobtypeedit', $it->jobtype_id) }}"
                                                        ...
                                                        <form action="{{ route('jobtypedelete', $it->jobtype_id) }}"
                        ...
                        deleteForms.forEach(form => {
                            form.addEventListener('submit', function(e) {
                                ...
                                Swal.fire({
                                    ...
                                    text: "Are you sure you want to delete this jobtype?'",
                                    icon: 'warning',
